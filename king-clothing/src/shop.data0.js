...
/* 
The data inside here, the way its stored might cause some performance problems  
In order to solve this performance problems, WE CAN NORMALIZE THE DATA, means to change
the ARRAY structure to the KEY:VALUE pair, just like in the firebase.
const SHOP_DATA = {
  hats: {
    id: 1,
    title: 'Hats',
...
After this change, we need to change the function selectCollection defined in the shop.selector.js,
and also we do not keep the COLLECTION_ID_MAP...

All theses changes done, but not in this version
*/
